...
#SBATCH --output=/home/dxl952/Cource/High_performance_AI/project/Llama3_1b/Distributed_training/pytorch_lighting/logs/output_1_2.log                # Standard output log
#SBATCH --error=/home/dxl952/Cource/High_performance_AI/project/Llama3_1b/Distributed_training/pytorch_lighting/logs/error_1_2.log                  # Standard error log
...
# Run the script
python train.py --num_nodes 1 --num_gpu_per_node 2